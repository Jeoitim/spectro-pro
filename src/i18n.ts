...
const ENGLISH: { [key: string]: string } = {
    ...
    '快捷键：空格播放或暂停；左右方向键按当前画面 1% 移动，按住 Shift 时按 5% 移动；长按方向键以正常速度试听，松开自动暂停。':
        'Shortcuts: Space plays or pauses; Left/Right moves by 1% of the visible view, or 5% with Shift. Hold an arrow key to audition at normal speed and release it to pause.',
    显示增益: 'Display gain',
